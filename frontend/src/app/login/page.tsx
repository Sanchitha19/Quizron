        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-brand-700 text-white rounded-xl font-medium text-sm hover:bg-brand-800 active:scale-95 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
